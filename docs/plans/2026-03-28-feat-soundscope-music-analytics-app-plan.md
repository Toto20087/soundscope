...
- [x] Build `src/app/page.tsx` (Server Component):
...
- [x] Build below-the-fold sections:
...
- [x] Build `src/app/artist/[name]/page.tsx` (Server Component):
...
- [x] Build `ArtistHero.tsx` (Section 3A):
...
- [x] Build `ArtistBio.tsx` (Section 3B - client):
...
- [x] Build `AlbumTimeline.tsx` (Section 3C - client):
...
- [x] Build `AlbumComparisonChart.tsx` (Section 3D - client):
...
- [x] Build `TopTracks.tsx` (Section 3E):
...
- [x] Build `FunFacts.tsx` (Section 3F):
...
- [x] Build `src/app/artist/[name]/album/[album]/page.tsx`:
...
- [x] Build `TrackDurationChart.tsx` (client):
